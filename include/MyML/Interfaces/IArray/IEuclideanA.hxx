...
struct IEuclideanA
    : SIVT_CRTP<TemplateList<IMetric, IAffine, IEuclideanAS, IArray>, Base,
                ImplP, ArgList> {
  ...
  using SIVT_CRTP<TemplateList<IMetric, IAffine, IEuclideanAS, IArray>, Base,
                  ImplP, ArgList>::SIVT_CRTP;
