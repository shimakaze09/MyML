...
#include "../IArray/IArrayUtil.hxx"

#include "IMatrix_detail.hxx"
...
struct IMatrix : SIVT_CRTP<TemplateList<IArrayUtil>, Base, Impl, ArgList> {
  ...
  using SIVT_CRTP<TemplateList<IArrayUtil>, Base, Impl, ArgList>::SIVT_CRTP;
  ...
  inline F& at(size_t r, size_t c) noexcept { return this->operator()(r, c); }
